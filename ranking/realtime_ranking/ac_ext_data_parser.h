#ifndef  __AC_EXT_DATA_PARSER_H_
#define  __AC_EXT_DATA_PARSER_H_

#include "ac_srm_doc_info.h"
#include "ac_miniblog.h"
#include "ac_miniblog_ext.h"
...
public:
     ...
     */
    /* ----------------------------------------------------------------------------*/
    static int get_debug_info(QsInfoBC *bcinfo, SrmDocInfo* doc);
